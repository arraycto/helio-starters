...
public class HelioProperties {
    ...
    public static class Crud {
         ...
         * 默认为mysql
         */
        @ApiModelProperty(value = "用的哪种数据库 如: mysql  postgresql(参考com.baomidou.mybatisplus.annotation.DbType)(默认为mysql)")
        ...
        public static class Tenant {
             ...
             * 默认为false
             */
            @ApiModelProperty(value = "是否启用多租户(默认为false)")
             ...
             * 默认为行级
             */
            @ApiModelProperty(value = "多租户隔离级别(默认为行级)")
        ...
        public static class OptimisticLock {
             ...
             * 默认为false
             */
            @ApiModelProperty(value = "是否启用乐观锁(默认为false)")
            private Boolean enabled = false;
        ...
        public static class IdGenerator {
             ...
             * 默认为SNOWFLAKE
             */
            @ApiModelProperty(value = "ID生成器策略(默认为SNOWFLAKE)")
             ...
             * 默认为0
             */
            @ApiModelProperty(value = "雪花ID-数据中心ID(默认为0)")
             ...
             * 默认为2021-01-01
             */
            @ApiModelProperty(value = "雪花ID-起始时刻(默认为2021-01-01)")
