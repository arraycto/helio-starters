...
public abstract class HelioBaseEntity<PK> implements Serializable {
    ...
    @TableField(value = HelioConstant.CRUD.COLUMN_CREATE_AT, fill = FieldFill.INSERT)
    ...
    @TableField(value = HelioConstant.CRUD.COLUMN_CREATE_BY, fill = FieldFill.INSERT)
    ...
    @DateTimeFormat(pattern = HelioConstant.Jackson.DATE_TIME_FORMAT)
    @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = HelioConstant.Jackson.DATE_TIME_FORMAT, timezone = HelioConstant.Jackson.TIME_ZONE)
    @TableField(value = HelioConstant.CRUD.COLUMN_UPDATE_AT, fill = FieldFill.INSERT_UPDATE)
    ...
    @TableField(value = HelioConstant.CRUD.COLUMN_UPDATE_BY, fill = FieldFill.INSERT_UPDATE)
