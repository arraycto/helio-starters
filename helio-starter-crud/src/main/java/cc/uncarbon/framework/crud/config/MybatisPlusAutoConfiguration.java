...
public class MybatisPlusAutoConfiguration {
    ...
    public MybatisPlusInterceptor mybatisPlusInterceptor() {
         ...
         */
        // 多租户
        if (helioProperties.getCrud().getTenant().getEnabled()) {
            // 行级租户隔离级别
            if (TenantIsolateLevelEnum.LINE.equals(helioProperties.getCrud().getTenant().getIsolateLevel())) {
        ...
        // 乐观锁
        if (helioProperties.getCrud().getOptimisticLock().getEnabled()) {
